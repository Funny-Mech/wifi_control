...
#define ATK_MW8266D_RST_GPIO_PIN            GPIO_PIN_2
#define ATK_MW8266D_RST_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0) /* PB口时钟使能 */
...
#define DEMO_WIFI_SSID          "TP-LINK_ECDE"
#define DEMO_WIFI_PWD           "999999999"
#define YUN_ID			        "02527008262302444466"
#define YUN_CODE			    "12345678"
